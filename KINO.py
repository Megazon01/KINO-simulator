...
print(f'Numbers found: 1:{num_found.count(1)}, 2:{num_found.count(2)}, 3:{num_found.count(3)}, 4:{num_found.count(4)},'
      f' 5:{num_found.count(5)}, 6:{num_found.count(6)}, 7:{num_found.count(7)}, 8:{num_found.count(8)}, '
      f'9:{num_found.count(9)}, 10:{num_found.count(10)}, 11:{num_found.count(11)}, 12:{num_found.count(12)}')

# Retrieve previous results
prev_results = fn.read_results(datafile)
